...
Write-Host '~ ~ ~ Remove Windows AI by @bibonuwu ~ ~ ~' -ForegroundColor DarkCyan
...
if ($nonInteractive) {
    ...
    $bgBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(13, 17, 23), 0.0))
    $bgBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(22, 27, 44), 0.5))
    $bgBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(13, 17, 23), 1.0))
    $window.Background = [System.Windows.Media.Brushes]::Transparent
    $window.Foreground = [System.Windows.Media.Brushes]::White

    # Outer border for rounded window
    $windowBorder = New-Object System.Windows.Controls.Border
    $windowBorder.Background = $bgBrush
    $windowBorder.CornerRadius = [System.Windows.CornerRadius]::new(16)
    $windowBorder.BorderBrush = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromArgb(80, 99, 102, 241))
    $windowBorder.BorderThickness = [System.Windows.Thickness]::new(1.5)
    ...
    $windowBorder.Child = $mainGrid

    # Title bar row (draggable)
    $titleBarRow = New-Object System.Windows.Controls.RowDefinition
    $titleBarRow.Height = [System.Windows.GridLength]::new(40)
    $mainGrid.RowDefinitions.Add($titleBarRow) | Out-Null

    $titleRow = New-Object System.Windows.Controls.RowDefinition
    $titleRow.Height = [System.Windows.GridLength]::new(70)
    ...
    # Custom title bar with drag and close button
    ...
    $closeButton.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(160, 160, 180))
    ...
    $closeButton.Margin = [System.Windows.Thickness]::new(0, 4, 8, 0)
    $closeButton.Cursor = 'Hand'
    $closeButtonTemplate = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="closeBorder" Background="Transparent" CornerRadius="8">
...
'@
    $closeButton.Template = [System.Windows.Markup.XamlReader]::Parse($closeButtonTemplate)
    $closeButton.Add_Click({ $window.Close() })
    $titleBar.Children.Add($closeButton) | Out-Null
    $mainGrid.Children.Add($titleBar) | Out-Null

    # Title with gradient text
    $titlePanel = New-Object System.Windows.Controls.StackPanel
    $titlePanel.HorizontalAlignment = 'Center'
    $titlePanel.VerticalAlignment = 'Center'
    [System.Windows.Controls.Grid]::SetRow($titlePanel, 1)
    ...
    $titleGradient = New-Object System.Windows.Media.LinearGradientBrush
    $titleGradient.StartPoint = [System.Windows.Point]::new(0, 0)
    $titleGradient.EndPoint = [System.Windows.Point]::new(1, 0)
    $titleGradient.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(99, 102, 241), 0.0))
    $titleGradient.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(168, 85, 247), 0.5))
    $titleGradient.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(236, 72, 153), 1.0))
    $title.Foreground = $titleGradient

    $subtitle = New-Object System.Windows.Controls.TextBlock
    $subtitle.Text = 'by @bibonuwu'
    $subtitle.FontSize = 11
    $subtitle.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(120, 120, 150))
    ...
    $mainGrid.Children.Add($titlePanel) | Out-Null

    $scrollViewer = New-Object System.Windows.Controls.ScrollViewer
    $scrollViewer.VerticalScrollBarVisibility = 'Auto'
    $scrollViewer.Margin = '24,10,24,10'
                                                        ...
                                                        <Thumb>
                                                            <Thumb.Style>
                                                                <Style TargetType="Thumb">
                                                                    <Setter Property="Background" Value="#4a4e6a"/>
                                                                    <Setter Property="Template">
                                                                        <Setter.Value>
        ...
        <Setter.Value>
            <ControlTemplate TargetType="{x:Type CheckBox}">
                <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                    <Border x:Name="checkBorder" Width="20" Height="20" CornerRadius="6"
                            Background="#1e2235" BorderBrush="#3a3f5c" BorderThickness="1.5"
                            VerticalAlignment="Center" Margin="0,0,10,0">
                        <TextBlock x:Name="checkMark" Text="&#x2713;" FontSize="13" FontWeight="Bold"
                ...
                <ControlTemplate.Triggers>
                    <Trigger Property="IsChecked" Value="True">
                        <Setter TargetName="checkBorder" Property="Background" Value="#6366f1"/>
                        <Setter TargetName="checkBorder" Property="BorderBrush" Value="#818cf8"/>
                        <Setter TargetName="checkMark" Property="Visibility" Value="Visible"/>
                    </Trigger>
                    <Trigger Property="IsMouseOver" Value="True">
                        <Setter TargetName="checkBorder" Property="BorderBrush" Value="#6366f1"/>
                    </Trigger>
                </ControlTemplate.Triggers>
            </ControlTemplate>
        </Setter.Value>
...
'@
    $checkboxStyle = [System.Windows.Markup.XamlReader]::Parse($checkboxStyleXaml)

    # Info button template with hover
    $infoButtonTemplateXaml = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="infoBorder" Background="#252845" BorderBrush="#3a3f5c" BorderThickness="1" CornerRadius="12">
        <ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/>
    </Border>
    <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
            <Setter TargetName="infoBorder" Property="Background" Value="#6366f1"/>
            <Setter TargetName="infoBorder" Property="BorderBrush" Value="#818cf8"/>
        </Trigger>
    </ControlTemplate.Triggers>
</ControlTemplate>
'@
    ...
    foreach ($func in $functions) {
        ...
        $optionContainer.Margin = '4,4,4,4'
        $optionContainer.LastChildFill = $false

        $checkbox = New-Object System.Windows.Controls.CheckBox
        $checkbox.Content = $func.Replace('-', ' ')
        $checkbox.FontSize = 13
        $checkbox.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(210, 210, 230))
        ...
        $infoButton.FontSize = 11
        $infoButton.FontWeight = 'Bold'
        $infoButton.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(160, 165, 200))
        $infoButton.Background = [System.Windows.Media.Brushes]::Transparent
        ...
        $infoButton.Template = [System.Windows.Markup.XamlReader]::Parse($infoButtonTemplateXaml)
...
'@
    ...
    $divider.Height = 1
    $divider.Margin = '0,14,0,14'
    $dividerBrush = New-Object System.Windows.Media.LinearGradientBrush
    $dividerBrush.StartPoint = [System.Windows.Point]::new(0, 0)
    $dividerBrush.EndPoint = [System.Windows.Point]::new(1, 0)
    $dividerBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Colors]::Transparent, 0.0))
    $dividerBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromArgb(100, 99, 102, 241), 0.5))
    $dividerBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Colors]::Transparent, 1.0))
    ...
    $classicAppsHeader.FontSize = 15
    $classicAppsHeader.FontWeight = 'SemiBold'
    $classicAppsHeaderGradient = New-Object System.Windows.Media.LinearGradientBrush
    $classicAppsHeaderGradient.StartPoint = [System.Windows.Point]::new(0, 0)
    $classicAppsHeaderGradient.EndPoint = [System.Windows.Point]::new(1, 0)
    $classicAppsHeaderGradient.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(99, 102, 241), 0.0))
    $classicAppsHeaderGradient.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(168, 85, 247), 1.0))
    $classicAppsHeader.Foreground = $classicAppsHeaderGradient
    $classicAppsHeader.Margin = '0,6,0,10'
    ...
    [System.Windows.Controls.Grid]::SetRow($toggleGrid, 3)
    $toggleGrid.Margin = '28,10,55,15'
    ...
    $toggleLabel1.FontSize = 13
    $toggleLabel1.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(200, 200, 220))
    ...
    $revertInfoButton.Width = 24
    $revertInfoButton.Height = 24
    $revertInfoButton.FontSize = 11
    $revertInfoButton.FontWeight = 'Bold'
    $revertInfoButton.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(160, 165, 200))
    $revertInfoButton.Background = [System.Windows.Media.Brushes]::Transparent
    ...
    $revertInfoButton.Template = [System.Windows.Markup.XamlReader]::Parse($infoButtonTemplateXaml)
    ...
    $toggleLabel2.FontSize = 13
    $toggleLabel2.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(200, 200, 220))
    ...
    $backupInfoButton.Width = 24
    $backupInfoButton.Height = 24
    $backupInfoButton.FontSize = 11
    $backupInfoButton.FontWeight = 'Bold'
    $backupInfoButton.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(160, 165, 200))
    $backupInfoButton.Background = [System.Windows.Media.Brushes]::Transparent
    ...
    $backupInfoButton.Template = [System.Windows.Markup.XamlReader]::Parse($infoButtonTemplateXaml)
    ...
    [System.Windows.Controls.Grid]::SetRow($bottomGrid, 4)
    $bottomGrid.Margin = '28,15,28,18'
    ...
    $discordButton.Width = 38
    $discordButton.Height = 38
    $discordButton.Background = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(88, 101, 242))
    ...
    $discordTemplate = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="socialBorder" Background="{TemplateBinding Background}"
    ...
    <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
            <Setter TargetName="socialBorder" Property="Opacity" Value="0.8"/>
        </Trigger>
    </ControlTemplate.Triggers>
</ControlTemplate>
'@
    ...
    $githubButton.Width = 38
    $githubButton.Height = 38
    $githubButton.Background = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(45, 45, 55))
    $githubButton.BorderBrush = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromArgb(60, 99, 102, 241))
    $githubButton.BorderThickness = [System.Windows.Thickness]::new(1)
    ...
    $githubTemplate = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="ghBorder" Background="{TemplateBinding Background}"
            BorderBrush="{TemplateBinding BorderBrush}"
            BorderThickness="{TemplateBinding BorderThickness}"
            CornerRadius="10">
        <ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/>
    ...
    <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
            <Setter TargetName="ghBorder" Property="Opacity" Value="0.8"/>
        </Trigger>
    </ControlTemplate.Triggers>
</ControlTemplate>
'@
    ...
    $cancelButton.Background = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(40, 42, 60))
    $cancelButton.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(200, 200, 220))
    $cancelButton.BorderBrush = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromArgb(80, 99, 102, 241))
    ...
    $cancelTemplate = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="cancelBorder" Background="#282a3c" BorderBrush="#3a3f5c" BorderThickness="1" CornerRadius="10">
        <ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/>
    </Border>
    <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
            <Setter TargetName="cancelBorder" Property="Background" Value="#ef4444"/>
            <Setter TargetName="cancelBorder" Property="BorderBrush" Value="#f87171"/>
            <Setter Property="Foreground" Value="White"/>
        </Trigger>
    </ControlTemplate.Triggers>
</ControlTemplate>
'@
    ...
    $applyButton.Background = [System.Windows.Media.Brushes]::Transparent
    ...
    $applyTemplate = @'
<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" TargetType="Button">
    <Border x:Name="applyBorder" CornerRadius="10">
        <Border.Background>
    ...
    <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
            <Setter TargetName="applyBorder" Property="Background">
                <Setter.Value>
                    <LinearGradientBrush StartPoint="0,0" EndPoint="1,1">
...
'@
    ...
    $applyButton.Add_Click({
            ...
            $progressWindow.Background = [System.Windows.Media.Brushes]::Transparent
            ...
            $progressBorder.CornerRadius = [System.Windows.CornerRadius]::new(14)
            $progressBorder.BorderBrush = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromArgb(80, 99, 102, 241))
            $progressBorder.BorderThickness = [System.Windows.Thickness]::new(1)
            $progBgBrush = New-Object System.Windows.Media.LinearGradientBrush
            $progBgBrush.StartPoint = [System.Windows.Point]::new(0, 0)
            $progBgBrush.EndPoint = [System.Windows.Point]::new(1, 1)
            $progBgBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(18, 20, 30), 0.0))
            $progBgBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(28, 32, 52), 1.0))
            $progressBorder.Background = $progBgBrush
            $progressBorder.Effect = New-Object System.Windows.Media.Effects.DropShadowEffect -Property @{
                Color       = [System.Windows.Media.Color]::FromRgb(0, 0, 0)
                Direction   = 270
                ShadowDepth = 4
                BlurRadius  = 20
            ...
            $progressStack.VerticalAlignment = 'Center'
            $progressStack.HorizontalAlignment = 'Center'
            $progressStack.Margin = [System.Windows.Thickness]::new(30)
            ...
            $progressTextBrush = New-Object System.Windows.Media.LinearGradientBrush
            $progressTextBrush.StartPoint = [System.Windows.Point]::new(0, 0)
            $progressTextBrush.EndPoint = [System.Windows.Point]::new(1, 0)
            $progressTextBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(99, 102, 241), 0.0))
            $progressTextBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(168, 85, 247), 1.0))
            $progressText.Foreground = $progressTextBrush
            ...
            $progressBarBorder = New-Object System.Windows.Controls.Border
            $progressBarBorder.Height = 4
            $progressBarBorder.CornerRadius = [System.Windows.CornerRadius]::new(2)
            $progressBarBorder.Background = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(30, 34, 53))
            $progressBarBorder.Margin = [System.Windows.Thickness]::new(0, 16, 0, 0)
            $progressBarBorder.ClipToBounds = $true

            $progressBarFill = New-Object System.Windows.Controls.Border
            $progressBarFill.Height = 4
            $progressBarFill.CornerRadius = [System.Windows.CornerRadius]::new(2)
            $progressBarFill.HorizontalAlignment = 'Left'
            $progressBarFill.Width = 80
            $progressBarFillBrush = New-Object System.Windows.Media.LinearGradientBrush
            $progressBarFillBrush.StartPoint = [System.Windows.Point]::new(0, 0)
            $progressBarFillBrush.EndPoint = [System.Windows.Point]::new(1, 0)
            $progressBarFillBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(99, 102, 241), 0.0))
            $progressBarFillBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(168, 85, 247), 0.5))
            $progressBarFillBrush.GradientStops.Add([System.Windows.Media.GradientStop]::new([System.Windows.Media.Color]::FromRgb(236, 72, 153), 1.0))
            $progressBarFill.Background = $progressBarFillBrush
            $progressBarBorder.Child = $progressBarFill
            $progressStack.Children.Add($progressBarBorder) | Out-Null
            ...
            try {
                ...
                $progressText.Foreground = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.Color]::FromRgb(74, 222, 128))
